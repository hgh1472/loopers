...
public interface ProductJpaRepository extends JpaRepository<Product, Long> {
    ...
    Slice<ProductSearchView> searchLatestProducts(@Param("brandId") Long brandId, Pageable pageable);
    ...
    Slice<ProductSearchView> searchPriceAscProducts(@Param("brandId") Long brandId, Pageable pageable);
    ...
    Slice<ProductSearchView> searchLikeDescProducts(@Param("brandId") Long brandId, Pageable pageable);
